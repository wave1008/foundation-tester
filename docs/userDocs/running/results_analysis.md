...
| `ftester results insights` | Regressions, consecutive failures, infrastructure-caused failures, stale selectors |
...
insights — backed by the same `ftester results` data. See "結果ダッシュボード" in

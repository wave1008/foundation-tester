...
// **この SUT に置く意味**: Android は WebView の中身が a11y の仮想ツリーとして降りてくるが、
// リンクは Chromium のロール名(chromeRole)を見ないと iOS と型が食い違う。
// その正規化と、WebView コンテナ(resource-id を持たない)が `.webView` で指せることを確かめる。

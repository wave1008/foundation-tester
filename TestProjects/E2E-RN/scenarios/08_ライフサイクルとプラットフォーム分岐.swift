        ...
        scenario {
            ...
            scene(3, "10.S0030: コントロールタブを開いて初期値を確認") {
                condition {
                    ...
                    // 状態は echo とは別に要素そのものからも読む(iOS の Flutter/RN は value で出す。
                    // 2026-09-18 まで value を読まず checkIsON が落ちていた)。radio_a を先にオンで
                    // 見ておくと、オンしか報告しない実装(Flutter iOS の Radio)でも後のオフが確定する

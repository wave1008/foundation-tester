...
public enum DSLCommandIndex {
    ...
    public static let all: [DSLCommandInfo] = [
        ...
        .init("isEnabled", "existence", "isEnabled(selector, timeout:)",
              "Asserts the element is enabled.", chainable: true),
        .init("isDisabled", "existence", "isDisabled(selector, timeout:)",
              "Asserts the element is disabled.", chainable: true),
        .init("isChecked", "existence", "isChecked(selector, timeout:)",
              "Asserts the element is checked.", chainable: true),
        .init("isNotChecked", "existence", "isNotChecked(selector, timeout:)",

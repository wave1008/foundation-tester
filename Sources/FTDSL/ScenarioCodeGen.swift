...
public enum ScenarioCodeGen {
    ...
    public static func render(flow: Flow, className: String, generatedBy: String,
                              emptyExpectation: Bool = false) -> String {
        var lines: [String] = []
        ...
        } else if emptyExpectation {
            lines.append(closing + ".expectation {")
            lines.append(indent + "// TODO: assert what this scenario is supposed to prove"
                + " (e.g. textIs(\"…\") / exist(\"#id\")).")
            lines.append(indent + "// An empty expectation is intentional — ft_dry_run reports it"

...
// stdout レコード形式(契約。対向: Sources/fleetest-androidstream/main.m・
// vscode-fleetest/src/deviceStream.ts。3ファイルとも直すこと):
...
@autoreleasepool {
    ...
    if (udid.length == 0 || (![codec isEqualToString:@"mjpeg"] && ![codec isEqualToString:@"h264"])) {
        fprintf(stderr, "usage: fleetest-simstream --udid <UDID> [--fps <n>] [--max-width <px>] [--codec h264|mjpeg]\n");
        return 2;
    }
    gFps = (fps > 0) ? fps : 12;

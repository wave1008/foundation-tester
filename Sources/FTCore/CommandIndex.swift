...
public enum DSLCommandIndex {
    ...
    public static let all: [DSLCommandInfo] = [
        ...
        .init("type", "operation",
              "type(selector, text, replace:, timeout:, scroll:, maxSwipes:) / type(text, replace:)",
        ...
        .init("clearInput", "operation",
              "clearInput(selector, timeout:, scroll:, maxSwipes:) / clearInput()",
        ...
        .init("swipeBy", "operation",
              "swipeBy(selector?, dxRatio:, dyRatio:, durationSeconds:, timeout:)",
        ...
        .init("doubleTap", "operation", "doubleTap(selector?, timeout:)",
              "Double-taps. No selector = the center of the screen."),
        .init("pinchOut", "operation", "pinchOut(selector?, scale:, durationSeconds:, timeout:)",
              "Pinches open (zoom in). scale must be > 1. No selector = the whole screen."),
        .init("pinchIn", "operation", "pinchIn(selector?, scale:, durationSeconds:, timeout:)",
              "Pinches closed (zoom out). scale must be between 0 and 1."),
        .init("swipeElementToElement", "operation",
              "swipeElementToElement(from, to, durationSeconds:, timeout:)",
        ...
        .init("existImageWithScrollDown", "scroll",
              "existImageWithScrollDown(label, threshold:, aspectRatioTolerance:, maxSwipes:)",
              "Alias of existImage(label, scroll: .down). There is no left/right alias."),
        .init("existImageWithScrollUp", "scroll",
              "existImageWithScrollUp(label, threshold:, aspectRatioTolerance:, maxSwipes:)",
              "Alias of existImage(label, scroll: .up). There is no left/right alias."),
        .init("existImageWithoutScroll", "scroll",
              "existImageWithoutScroll(label, threshold:, aspectRatioTolerance:, timeout:)",
              "existImage on the current screen even inside a withScroll* block."),
        ...
        .init("existImage", "existence",
              "existImage(label, threshold:, aspectRatioTolerance:, timeout:, scroll:, maxSwipes:)",
        ...
        .init("repeatWhileCanSelect", "control",
              "repeatWhileCanSelect(selector, max:, waitSeconds:, title:) { }",

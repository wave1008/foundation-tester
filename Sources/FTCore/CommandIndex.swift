...
public enum DSLCommandIndex {
    ...
    public static let all: [DSLCommandInfo] = [
        ...
        .init("tap", "operation",
              ...
              chainable: true),
        .init("select", "operation", "select(selector, waitSeconds:, requireVisible:, scroll:, maxSwipes:)",
        ...
        // MARK: existence
        .init("exist", "existence", "exist(selector, waitSeconds:, requireVisible:, scroll:, maxSwipes:)",

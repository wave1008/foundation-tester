// VSCode拡張のライブ操作タブの記録機能向け(fleetest api gen-scenario)。--steps の一時 JSON
...
struct ApiGenScenarioCommand: AsyncParsableCommand {
    ...
    func run() async throws {
        ...
        let flow = Flow(name: testDescription, app: recorded.app, platform: recorded.platform,
                        goal: nil, generatedBy: "fleetest record v0.1", steps: recorded.steps)
        ...
        let code = ScenarioCodeGen.render(
            flow: flow, className: className, generatedBy: "fleetest record v0.1")

...
// 読むだけ(Sources/FTCore/FMUsageLedger.swift 参照)。visionCalls/visionFailures/visionTotalMs も同じ
// 供給経路(VisionUsageLedger。呼ぶのは RegionText の OCR と VisionClassifier の推論・学習)。
//

// VSCode拡張等の外部ツール向け機械可読 CLI(fleetest api ...)。
...
struct ApiCommand: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        subcommands: [ApiListScenarios.self, ApiSteps.self, ApiRunCommand.self,
                      ...
                      ApiListApps.self, ApiDeviceUp.self, ApiDeviceDown.self, ApiDeviceWipe.self,
                      ApiDevicesUp.self,
...
/// fleetest api list-scenarios の 1 シナリオ分の出力。
...
/// 対向: vscode-fleetest/src/model.ts EmptyClassInfo、testTree.ts。
...
/// fleetest api list-scenarios の出力全体
...
/// fleetest api steps の 1 ステップ分の出力。省略可能なフィールドは JSON 上で "null" を明示する

...
// schemas/{app,run}-profile.schema.json が実在の
// TestProjects/SampleApp/profiles/{apps,runs}/*.json 全ファイルを受理することを確認する。
//
...
//
// src/*.ts には依存しない(vscode-fleetest の TypeScript 側ではなく、拡張マニフェストが指す

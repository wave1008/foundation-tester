...
export const panelsStrings = {
  ...
  "panels.hostMetrics.visionTitle": { ja: "Vision(OCR・画像分類器)呼び出し回数", en: "Vision (OCR / image classifier) call count" },
  ...
  "panels.settings.remoteHostsColEnabled": { ja: "マシン有効", en: "Machine enabled" },
  ...
  "panels.deviceAdd.batchCountTitle": {
    ja: "作成する台数(1-99)",
    en: "How many devices to create (1-99)",
  },
  ...
  "panels.live.refreshSnapshot": { ja: "更新", en: "Refresh" },

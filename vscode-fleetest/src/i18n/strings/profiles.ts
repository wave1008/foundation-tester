...
export const profilesStrings = {
  ...
  "profiles.log.runProfileSetFailed": {
    ja: "[fleetest] 実行プロファイルの設定に失敗しました({name}): {error}",
    en: "[fleetest] Failed to set the run profile ({name}): {error}",
  },
  "profiles.log.runProfileAdded": {
    ja: "[fleetest] 実行プロファイル「{name}」を追加しました。",
    en: "[fleetest] Added run profile \"{name}\".",
  },
  "profiles.log.runProfileAddFailed": {
    ja: "[fleetest] 実行プロファイル「{name}」の追加に失敗しました: {error}",
    en: "[fleetest] Failed to add run profile \"{name}\": {error}",
  },
  ...
  "profiles.log.runProfileCopied": {
    ja: "[fleetest] 実行プロファイル「{source}」を「{name}」としてコピーしました。",
    en: "[fleetest] Copied run profile \"{source}\" as \"{name}\".",
  },
  "profiles.log.runProfileCopyFailed": {
    ja: "[fleetest] 実行プロファイル「{name}」のコピーに失敗しました: {error}",
    en: "[fleetest] Failed to copy run profile \"{name}\": {error}",
  },
  ...
  "profiles.log.runProfileDeleted": {
    ja: "[fleetest] 実行プロファイル「{name}」を削除しました。",
    en: "[fleetest] Deleted run profile \"{name}\".",
  },
  "profiles.log.runProfileDeleteFailed": {
    ja: "[fleetest] 実行プロファイル「{name}」の削除に失敗しました: {error}",
    en: "[fleetest] Failed to delete run profile \"{name}\": {error}",
  },
  ...
  "profiles.log.runProfileRenamed": {
    ja: "[fleetest] 実行プロファイル「{oldName}」を「{newName}」に変更しました。",
    en: "[fleetest] Renamed run profile \"{oldName}\" to \"{newName}\".",
  },
  "profiles.log.runProfileRenameFailed": {
    ja: "[fleetest] 実行プロファイル「{name}」の名前変更に失敗しました: {error}",
    en: "[fleetest] Failed to rename run profile \"{name}\": {error}",
  },
  ...
  "profiles.log.runProfileLoadFailed": {
    ...
    en: "[fleetest] Failed to load run profile \"{name}\": {error}",
  },
  ...
  "profiles.log.runProfileWriteFailed": {
    ja: "[fleetest] 実行プロファイル「{name}」の書き込みに失敗しました: {error}",
    en: "[fleetest] Failed to write run profile \"{name}\": {error}",
  },
  ...
  "profiles.log.runProfileUpdated": {
    ja: "[fleetest] 実行プロファイル「{name}」を更新しました。",
    en: "[fleetest] Updated run profile \"{name}\".",
  },

  // ---- アプリプロファイル ----
  "profiles.log.appProfileAdded": {
    ja: "[fleetest] アプリプロファイル「{name}」を追加しました。",
    en: "[fleetest] Added app profile \"{name}\".",
  },
  "profiles.log.appProfileAddFailed": {
    ja: "[fleetest] アプリプロファイル「{name}」の追加に失敗しました: {error}",
    en: "[fleetest] Failed to add app profile \"{name}\": {error}",
  },
  ...
  "profiles.log.appProfileCopied": {
    ja: "[fleetest] アプリプロファイル「{source}」を「{name}」としてコピーしました。",
    en: "[fleetest] Copied app profile \"{source}\" as \"{name}\".",
  },
  "profiles.log.appProfileCopyFailed": {
    ja: "[fleetest] アプリプロファイル「{name}」のコピーに失敗しました: {error}",
    en: "[fleetest] Failed to copy app profile \"{name}\": {error}",
  },
  ...
  "profiles.log.appProfileDeleted": {
    ja: "[fleetest] アプリプロファイル「{name}」を削除しました。",
    en: "[fleetest] Deleted app profile \"{name}\".",
  },
  "profiles.log.appProfileDeleteFailed": {
    ja: "[fleetest] アプリプロファイル「{name}」の削除に失敗しました: {error}",
    en: "[fleetest] Failed to delete app profile \"{name}\": {error}",
  },
  ...
  "profiles.log.appProfileRenamed": {
    ja: "[fleetest] アプリプロファイル「{oldName}」を「{newName}」に変更しました。",
    en: "[fleetest] Renamed app profile \"{oldName}\" to \"{newName}\".",
  },
  "profiles.log.appProfileRenameFailed": {
    ja: "[fleetest] アプリプロファイル「{name}」の名前変更に失敗しました: {error}",
    en: "[fleetest] Failed to rename app profile \"{name}\": {error}",
  },
  ...
  "profiles.log.appProfileLoadFailed": {
    ja: "[fleetest] アプリプロファイル「{name}」の読み込みに失敗しました: {error}",
    en: "[fleetest] Failed to load app profile \"{name}\": {error}",
  },
  ...
  "profiles.log.appProfileWriteFailed": {
    ja: "[fleetest] アプリプロファイル「{name}」の書き込みに失敗しました: {error}",
    en: "[fleetest] Failed to write app profile \"{name}\": {error}",
  },
  ...
  "profiles.log.appProfileUpdated": {
    ja: "[fleetest] アプリプロファイル「{name}」を更新しました。",

// extension 側の i18n ランタイム。t() で辞書を引き、locale は fleetest.language 設定
...
import { resultsExportStrings } from "./strings/resultsExport";
...
function computeLocale(): Locale {
  const setting = vscode.workspace.getConfiguration("fleetest").get<string>("language", "auto");
...
/** fleetest.language 設定と vscode.env.language から現在 locale を再計算して反映する。 */

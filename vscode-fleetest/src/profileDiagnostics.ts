...
// `fleetest api validate-profile`(Sources/fleetest/ApiValidateProfileCommand.swift)の検証結果を
// 問題パネル(DiagnosticCollection "fleetest-profile")へ反映する。
...
const COLLECTION_NAME = "fleetest-profile";
...
export function registerProfileDiagnostics(
  ...
  context.subscriptions.push(
    ...
    vscode.commands.registerCommand("fleetest.validateProfiles", async () => {

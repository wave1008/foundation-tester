...
test("parseRunProfileForForm: 正常な値は10フィールドをそのまま読み取る", () => {
...
test("parseRunProfileForForm: 欠落キーは既定値(machine/app/reportDir/locale=''、devices=[]、heal=false、iosInappEngine=true、defaultTimeout=''、wipeDataOnBloat=true、wipeDataThresholdGB='')", () => {
  const parsed = parseRunProfileForForm({});
  assert.deepEqual(parsed, {
    machine: "",
    app: "",
